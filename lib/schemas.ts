...
const PaymentInformationSchema = z.object({
  ...
  IFSCcode: fieldValidators.stringMin1,
  Gstin: fieldValidators.stringMin1,
});
...
const InvoiceDetailsSchema = z.object({
  ...
  currency2: fieldValidators.string.optional(),
  conversion: fieldValidators.string.optional(),
  ...
  cgsttaxDetails: cgstTaxDetailsSchema.optional(),
  sgsttaxDetails: sgstTaxDetailsSchema.optional(),
